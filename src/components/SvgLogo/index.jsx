    ...
    <SvgWrapper>
      <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="1580.831" height="729.501" viewBox="0 0 1580.831 729.501">
          ...
          <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#Path_859)">
            <path id="Path_859-2" data-name="Path 859" d="M402.8,398.814h-160L321.11,124.6H651.52L620.56,226.065H450.152Z" transform="translate(265.64 170.61)" fill="#ececec" fillRule="evenodd"/>
          </g>
      </svg>
    </SvgWrapper>
  </>
